...
//
                                    ...
                                    <tr>
                                        ...
                                        <td> <p style="float: right;width: 300px;">
                                            ...
                                            <button class="btn btn-primary"  onclick="Join()"><i class="glyphicon glyphicon-plus"></i>参加</button>
        ...
        <script>
            function Skip()
            {
                window.location.href="stuCourseAnnouncement.jsp";
            }
            function Join() {
                var number = document.getElementById("number").value;
                var url = "select_courseServlet?courseNumber=" + number;
