<%--
  ~ Copyright (c) 2018
  ~ User:Hongb
  ~ File:stuInfoUpdate.jsp
  ~ Date:2018/06/04 21:50:04
  --%>
...
<script>
    ...
    function submit() {
        ...
        if(userPassword===userSecondPassword) {
            ...
            var url = "updateStuServlet?name=" + userName + "&sex=" + userGender + "&password=" + userPassword+"&email="+email+"&school="+school+"&college="+college;
            window.location = url;
            // alert(("！"))
        }else {
