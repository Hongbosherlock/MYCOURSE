    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="studentHome.jsp" ><i></i>我的课程</a>
                </li>
                ...
                <li>
                    <a class="active-menu" href=""><i ></i>个人信息 </a>
                ...
                <div class="panel panel-default">
                    ...
                    <div  class="row pad-top-botm client-info">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <b>姓名：<strong><%= ((stuinfo)request.getSession().getAttribute("student")).getName()%></strong></b> <br />
                            <b>School :</b> <%= ((stuinfo)request.getSession().getAttribute("student")).getSchool()%> <br />
                            <b>学院 :</b> <%= ((stuinfo)request.getSession().getAttribute("student")).getCollege()%><br />
                            <b>E-mail :</b> <%= ((stuinfo)request.getSession().getAttribute("student")).getEmail()%>  </div>
                    ...
                    <br>
                        ...
                        <div class="row pad-top-botm">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <a href="stuInfoUpdate.jsp" class="btn btn-primary btn-lg" >个人信息修改</a>
                                <p>&nbsp;</p>
